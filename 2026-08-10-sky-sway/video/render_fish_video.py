#!/usr/bin/env python3
"""Render the sky-sway story video with Fish Audio's 哈基米 voice.
...
def main() -> None:
    ...
    parser.add_argument("--output", type=Path, default=VIDEO_DIR / "sky-sway-zh-fish.mp4")
    ...
    work_dir = Path(tempfile.mkdtemp(prefix="sky-sway-fish-video-build-", dir=str(VIDEO_DIR)))
