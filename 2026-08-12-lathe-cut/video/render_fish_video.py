#!/usr/bin/env python3
"""Render the lathe-cut story video with Fish Audio's 哈基米 voice.
...
def main() -> None:
    ...
    parser.add_argument("--output", type=Path, default=VIDEO_DIR / "lathe-cut-zh-fish.mp4")
    ...
    work_dir = Path(tempfile.mkdtemp(prefix="lathe-cut-fish-video-build-", dir=str(VIDEO_DIR)))
