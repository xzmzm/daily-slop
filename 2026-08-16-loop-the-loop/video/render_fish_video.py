#!/usr/bin/env python3
"""Render the loop-the-loop story video with Fish Audio's 哈基米 voice.
...
def main() -> None:
    ...
    parser.add_argument("--output", type=Path, default=VIDEO_DIR / "loop-the-loop-zh-fish.mp4")
    ...
    work_dir = Path(tempfile.mkdtemp(prefix="loop-the-loop-fish-video-build-", dir=str(VIDEO_DIR)))
