#!/usr/bin/env python3
"""Render the Montessori's-Shelf story video with Fish Audio's 哈基米 voice.
...
def main() -> None:
    ...
    work_dir = Path(tempfile.mkdtemp(prefix="carrington-storm-fish-video-build-", dir=str(VIDEO_DIR)))
    ...
    local.build_mp4(work_dir, narration, frames_dir, args.output)
    metadata = {
