#!/usr/bin/env python3
"""Render the Straight-Line-1927 story video with Fish Audio's 哈基米 voice.
...
def main() -> None:
    ...
    work_dir = Path(tempfile.mkdtemp(prefix="straight-line-fish-video-build-", dir=str(VIDEO_DIR)))
