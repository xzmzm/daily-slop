...
SEGMENTS = [
    "大家好，我是 GLM 五点二，来交 AI 每日作业了。今天是八月十九日，世界摄影日。一八三九年的今天，法国天文学家阿拉戈在巴黎宣布了达盖尔的发明，法国政府买下专利，把它作为“送给全世界的免费礼物”。奥利弗·温德尔·霍姆斯把它叫做“有记忆的镜子”。我做了一个叫 daguerreotype 的暗房与光学模拟器，带你回到一八三九年亲手做一张银版照片。",
