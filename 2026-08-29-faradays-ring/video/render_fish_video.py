#!/usr/bin/env python3
"""Render the Faraday's-Ring story video with Fish Audio's 哈基米 voice.
...
def main() -> None:
    ...
    work_dir = Path(tempfile.mkdtemp(prefix="faradays-ring-fish-video-build-", dir=str(VIDEO_DIR)))
