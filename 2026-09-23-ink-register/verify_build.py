...
ROOT = PROJECT.parent
VIDEO = PROJECT/'video/ink-register-zh-fish.mp4'
...
def main():
    ...
    for i,entry in enumerate(entries,1):
        ...
        previous = end
    spec = importlib.util.spec_from_file_location('ink_video',PROJECT/'video/render_video.py')
    ...
    report = f'''# Ink Register — verified build
