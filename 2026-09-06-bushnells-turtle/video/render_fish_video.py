#!/usr/bin/env python3
"""Render the Turtle-1776 story video with Fish Audio's 哈基米 voice.
...
def main() -> None:
    ...
    work_dir = Path(tempfile.mkdtemp(prefix="bushnells-turtle-fish-video-build-", dir=str(VIDEO_DIR)))
