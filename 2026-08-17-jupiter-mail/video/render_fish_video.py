#!/usr/bin/env python3
"""Render the jupiter-mail story video with Fish Audio's 哈基米 voice.
...
def main() -> None:
    ...
    parser.add_argument("--output", type=Path, default=VIDEO_DIR / "jupiter-mail-zh-fish.mp4")
    ...
    work_dir = Path(tempfile.mkdtemp(prefix="jupiter-mail-fish-video-build-", dir=str(VIDEO_DIR)))
