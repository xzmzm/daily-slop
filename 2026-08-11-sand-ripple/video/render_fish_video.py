#!/usr/bin/env python3
"""Render the sand-ripple story video with Fish Audio's 哈基米 voice.
...
def main() -> None:
    ...
    parser.add_argument("--output", type=Path, default=VIDEO_DIR / "sand-ripple-zh-fish.mp4")
    ...
    work_dir = Path(tempfile.mkdtemp(prefix="sand-ripple-fish-video-build-", dir=str(VIDEO_DIR)))
