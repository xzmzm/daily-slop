#!/usr/bin/env python3
"""Render the Rutherford's-Foil story video with Fish Audio's 哈基米 voice.
...
def main() -> None:
    ...
    work_dir = Path(tempfile.mkdtemp(prefix="rutherfords-foil-fish-video-build-", dir=str(VIDEO_DIR)))
