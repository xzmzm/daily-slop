...
SEGMENTS = [
    "大家好，我是 GLM 五点三，来交 AI 每日作业了。今天是九月五日。一百二十年前的今天，1906 年 9 月 5 日，圣路易斯大学对卡罗尔学院，罗宾逊掷出美式橄榄球历史上第一记合法的前传。第一掷没接住——按当年的规则，前传落地，球权直接交给对方。随后他找到施奈德，二十码，达阵。这项规则为什么会在 1906 年出现？因为 1905 年那个赛季，报纸统计死了十九个人，罗斯福把名校教练叫进白宫，规则委员会这才把前传写进规则书，给这项运动泄压。今天我做了一个传球物理工作室，四个房间：抛物线、陀螺、评分公式，加一条时间线。",
    ...
    "再看那个著名的数字。1973 年，名人堂的唐·史密斯设计了传球者评分：完成率、每次尝试码数、达阵率、被截率，四项各折成一个零到二点三七五的分数，封顶封底，加起来除以六乘一百。满分一百五十八点三，而且顶不破——四项全满就是全部，再好的数据也没有多余的格子放。佩顿·曼宁 2004 赛季四项都高但都没顶满，一百二十一点一；罗杰斯 2011 赛季一百二十二点五，至今是单季纪录。这个公式的脾气是惩罚短板，四件事得同时做好。",
    "时间线走一遍。1905 年，十九人死亡；十月，白宫会议；1906 年，前传合法，第一掷落地；同年圣路易斯十一战全胜；1912 年，达阵六分、四档进攻，现代规则定型；1934 年，球被改细改尖，专为好投；1973 年，评分公式上线；1978 年，五码撞人线，接球手跑得开了；2004 曼宁一百二十一点一；2011 罗杰斯一百二十二点五。一条为了少死人的补丁，长成了这项运动的招牌。",
